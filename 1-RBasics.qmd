...
```{r}
NFC_North <- c("Packers", "Vikings", "Lions", "Bears")
```
...
lumber <- "This tree would make"
lumber_2 <- "a good board."

paste(lumber, lumber_2)

NFC_South <- c("Tampa", "Atlanta", "Carolina", "New Orleans")

NFC <- c(NFC_North, NFC_South)
